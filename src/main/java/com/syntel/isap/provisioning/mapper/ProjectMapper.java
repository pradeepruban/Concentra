...
public interface ProjectMapper {
	...
	@Insert("INSERT INTO isap_env_vdc_proj_quota_map(proj_id,vdc_id,total_mem,total_vcpu,total_disk_storage,free_mem,free_vcpu,free_disk_storage,created_by)"
			+"VALUES(#{proj_id},#{vdc_id},#{total_mem},#{total_vcpu},#{total_disk_storage},#{free_mem},#{free_vcpu},#{free_disk_storage},#{created_by})")
