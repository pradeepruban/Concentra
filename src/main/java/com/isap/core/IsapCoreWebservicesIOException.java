...
@XmlRootElement(name = "IsapCoreWebservicesIOException")
public class IsapCoreWebservicesIOException {

    @XmlElementRef(name = "IOException", namespace = "http://core.isap.com", type = JAXBElement.class, required = false)
