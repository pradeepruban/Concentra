...
/**
 * <p>Java class for ListOpenstackKeypairsResp complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOpenstackKeypairsResp">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="keypairs" type="{http://responses.core.isap.com/xsd}ArrayOfString" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ListOpenstackKeypairsResp", propOrder = {
    "keypairs",
    "longMessage",
    "message",
    "returnCode"
})
public class ListOpenstackKeypairsResp {

    @XmlElement(nillable = true)
    protected List<ArrayOfString> keypairs;
     ...
     * 
     */
    public List<ArrayOfString> getKeypairs() {
        if (keypairs == null) {
            keypairs = new ArrayList<ArrayOfString>();
        }
