...
<html lang="en-us">
    <head>
        ...
        <title>ISAP Admin: Corporate Groups Management</title>
    ...
    <!-- END HEADER -->
		...
		<div id="main" role="main">
			...
			<div  class="modal fade" id="noCorpUserModal"  tabindex="-1" role="dialog" >
                   ...
                   <div  class="modal fade" id="sameCgVdcModal"  tabindex="-1" role="dialog" >
						<div class="modal-dialog">	            
				            <div class="modal-content">
                                <div class="modal-header">
                                   <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                    ...
                                    <h4 class="modal-title">
                                       Attention: Already Allocated Corporate!
                                    </h4>
                                </div>
                                <div class="modal-body no-padding">
                                 	&nbsp;&nbsp;&nbsp;<p>
						               	&nbsp;&nbsp;&nbsp;You already allocated same VDC to this Corporate group.<br>
						                &nbsp;&nbsp;&nbsp;Either Assign some other VDC, or go to Quota Menu to Edit existing VDC allocation. 
						            </p>
						        </div>
						        <div class="modal-footer">
                   ...
                   <div  class="modal fade" id="noVdcModal"  tabindex="-1" role="dialog" >
					...
					<div class="modal fade" id="vdcAssignmentModal" tabindex="-1" role="dialog">
								...
								<div class="modal-content">
										...
										<div class="modal-body no-padding">
											<form  id="allocateVdcform" class="smart-form" method="GET">
		...
		function check(){
			var cgId = $('#allocateVdcCgId').val();
			var vdcId =  $('#vdc_id').val();
			alert("check"+cgId+""+vdcId);
			
			$.getJSON("./checkPreviousdbpk/"+cgId+"/"+vdcId,function(response){
			alert(response+"response");
			if(response.flag==1){
				$('#vdcAssignmentModal').modal('hide');
				$('#sameCgVdcModal').modal('show');
			} else{
				document.allocateVdcform.action = "allocateVdcToCorporateGroup";
				document.allocateVdcform.submit();
			}
			 });
