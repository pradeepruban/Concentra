...
<html lang="en-us">
    ...
    <body class="desktop-detected menu-on-top pace-done smart-style-4">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
                                       ...
                                       <%-- <td><c:out value="${users.pD}"/></td> --%>
                               <%--               <c:choose>
                                            <c:when test="${users.status=='ACT'}">
                                           <td> <span class="label label-success">Active</span></td>
                                          </c:when>
                                         <c:when test="${users.status=='INA'}">
                                    ...
                                    <td> <span class="label label-success">Active</span></td>
                                        <td  style="padding-left: 3%;">
                                                ...
                                                <a title="delete" href="#" id = "${users.usr_id}" name = "${users.usr_desc}" onclick="deleteCorporateGroup(this)" role="button" ><i class="fa fa-trash-o"></i></a>
												</td>
                                        </tr>
                                     </c:forEach>
											</tbody>
		...
		<div id="dialog_simple" title="Dialog Simple Title">
            <p>
                Are you sure you want to delete the user: "<span id="user"> </span>" ?
            </p>
        </div>
