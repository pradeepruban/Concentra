...
<html lang="en-us">
    ...
    <body  class="desktop-detected menu-on-top pace-done smart-style-4">
		...
		<div id="main" role="main">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body no-padding">
											<form  action ="projects" id="login-form" class="smart-form" method="post">
													<fieldset>
		 ...
		 <td style="padding-left: 30px;">${project.proj_dec}</td>
		 <td style="padding-left: 30px;"> <span class="label label-success">${project.status}</span></td>
		<%-- <c:set var="status" value="${project.status}"/> 
		 <td style="padding-left: 10px;">
	<c:choose>
    <c:when test="${ status=='ACT'}">
