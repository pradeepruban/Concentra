		...
		<aside id="left-panel">
			...
			<nav>
				<ul>
					...
					<li >
						<a href="departmentGroup" title="OrganizationDesigner"><i class="fa  fa-user"></i> <span class="menu-item-parent">Department Group</span></a>
					</li>
						<li class="active">
						<a href="users"><i class="fa  fa-user"></i> <span class="menu-item-parent">Users</span></a>	
													...
													<fieldset>
														  ...
														  <section>
															...
															<div class="row">
																...
																<div class="col col-10">
																	<label class="input"> <i class="icon-append fa fa-envelope-o"></i>
																		<input type="password" name="cname">
																	</label>
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									     <thead>			                
											...
											<tbody>
                                                ...
                                                <a title="delete" href="#myModal" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
												</td>
												</tr>
