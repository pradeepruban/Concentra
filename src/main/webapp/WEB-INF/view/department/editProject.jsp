...
<script>
    ...
    <body  class="desktop-detected menu-on-top pace-done smart-style-4">
		...
		<aside id="left-panel">
			...
			<nav>
				<ul>
					...
					<li >
						<a href="users"><i class="fa fa-lg fa-fw fa-filter"></i> <span class="menu-item-parent">Map Users</span></a>
					</li>
					<li>
		...
		<div id="main" role="main">
     	...
     	<article class="col-sm-12 col-md-12 col-lg-9" style ="padding-left:25%">
							...
							<div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<form  id="editForm" name ="editForm" class="smart-form" method="POST">
										<input type="hidden" name="proj_id" value="${ProjectEditList.proj_id}">
											<header>
												Edit Project
											</header>
																...
																<div class="row">
																	...
																	<div class="col col-10">
																		<label class="input"> <i class="icon-append fa fa-user"></i>
																			<input type="text" name="proj_name" value="${ProjectEditList.proj_name}" >
																		</label>
																	</div>
																</div>
														</section>
															...
															<div class="row">
																...
																<div class="col col-10">
																	<label class="input"> <i class="icon-append fa fa-envelope-o"></i>
																		<input type="text" name="proj_desc"  value="${ProjectEditList.proj_desc}">
																	</label>
											...
											<footer>
												<button type="submit" onclick ="updateProjectList();" class="btn btn-primary">
												Update
												</button>
