...
<html lang="en-us">
	...
	<!-- 	<div id="main" role="main"> -->
		...
		<%-- 	<!-- RIBBON -->
			...
			<div  class="modal fade" id="noProjUserModal"  tabindex="-1" role="dialog" >
						<div class="modal-dialog">	            
				            <div class="modal-content">
                                <div class="modal-header">
                                   <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
		...
		<div class="modal fade" id="vdcAssignmentModal" tabindex="-1" role="dialog">
								...
								<div class="modal-content">
										...
										<div class="modal-body no-padding">
											<form action="allocateVdcToProject" id="allocateVdc-form" class="smart-form" method="GET">
 ...
 */
 ...
 function assignVdctoProject(departmentGroup){
		...
		//$('#dptname').text(name);
		 $.getJSON("./getAvailableVdcListforProject",function(response){
         		...
         		$('#noVdcModal').modal('show');
             	 ...
             	 $('#vdc_id').html('');  
	                    ...
	                    options += '<option selected="" disabled="" value="0"> Select VDC </option>';
	            		 ...
	            		 $.getJSON("./getVdcDetailsFromDepartmentTable/"+selectedVdcId+"/"+dptId,function(response){
						     ...
						     $.ajax({
						    	  ...
						    	  type:"post",
					                    ...
					                    //data: "{'selectedVdcId':'" + selectedVdcId + "', 'dptId': '" + dptId + "'}",
					                     ...
					                     data: "selectedVdcId=" + selectedVdcId + "&projId=" + projId,  
					                     
					                        success:function(data){
					                        if(data==0){
					                            $("#message").html(" <font color='green'> <b>This VDC not allocated for this Project </b> </font> ");
					                        }
					                        else{

					                            $("#message").html("  <font color='red'>This VDC is Allocated for this Project Choose different !  </font>  ");
