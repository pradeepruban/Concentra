...
<html lang="en-us">
	<head>
		...
		<title>ISAP Manager Order Approval </title>
			...
			<nav>
				<ul>
					...
					<li >
					 ...
					 <li class="active">
						<a href="#" title="Approval"><i class="fa fa-lg fa-fw fa-unlock-alt"></i> <span class="menu-item-parent">Approval</span></a>
					</li>
				</ul>
			</nav>
										...
										<thead>
											...
											<tbody>
													...
													<td>
											            ...
											            <button class='btn btn-xs btn-success'>Process</button>
														</td>			
													</tr>
												</tbody>
											</table>
