<html lang="en-us">
	<head>
		<meta charset="utf-8">
		<title> ISAP Manager Dashboard </title>
          ...
          <div id="logo-group">
			...
			<div class="pull-right">
               ...
               <div class="project-context hidden-xs">
                <span class="label">Tenant Manger: ( Project : STG Automtation Team )</span>
							   ...
							   <div class="col-md-2">				
								...
								<div class="col-md-4 padding-left-0">
									<h3 class="margin-top-0">
									  ...
									  <a class="btn btn-primary pull-right" href="stackManager"> Create Request </a>
                                      <br>
                                    </h3>
									
									<p>
										Order Your Enterprise Stack  <br><br>
								...
								<div class="col-md-4 padding-left-0">
									<h3 class="margin-top-0">
										...
										<a class="btn btn-primary pull-right" href="bespokeManager"> Create Request </a>	
									     <br>
									</h3>
									
									<p>
										Order  a VM with built in OS , appliance and configuration <br><br>
                                        On-demand Cloud servers <br><br>
                                        Choose your Usage period <br><br>
									</p>
								 </div>
								   ...
								   <div class="col-md-4 padding-left-0"></div>
									...
									<div class="col-md-4 padding-left-0">
									   <h3 class="margin-top-0">
										   ...
										   <a class="btn btn-primary pull-right" href="customManager"> Create Request </a>
									       <br>
									    </h3>
									<p>
										Order your VM and select your hardware configuration <br><br>
                                        On-demand Cloud servers <br><br>
